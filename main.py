...
while (1):
    ...
    stock = input("What ticker would to like me to predict? ")
    ...
    # Printing out graph of stock close prices by date
    close = data['Close']
    ...
    # Predict Stock Trend of chosen stock using Facebook Prophet
    model = Prophet()
    model.fit(data)
    ...
    start_or_end = input("Continue? Type yes or no: ")
    if (start_or_end != 'yes'):
        break
